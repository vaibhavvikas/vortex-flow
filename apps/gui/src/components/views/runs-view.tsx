    ...
    <div className="p-6 space-y-6 w-full">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-muted-foreground">Monitor real-time engine jobs and execution history</p>
        </div>
        <Button size="sm">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="flex items-center gap-2">
                    <span className="text-xs font-mono font-medium text-muted-foreground">{run.id}</span>
                    <h3 className="text-sm font-semibold">{run.name}</h3>
                  </div>
                  <p className="text-xs text-muted-foreground">{run.date} • Duration: {run.duration}</p>
                </div>
              </div>
