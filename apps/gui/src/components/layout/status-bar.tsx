...
export function StatusBar({
  ...
  return (
    <footer className="h-8 shrink-0 border-t border-border bg-sidebar text-sidebar-foreground flex items-center justify-between px-4 text-xs font-sans select-none z-20 w-full">
      {/* Left indicators */}
      ...
      <div className="flex items-center gap-3">
        ...
        <Badge variant="outline" className="text-xs h-5 px-1.5 py-0 border-sidebar-border text-muted-foreground font-mono font-normal">
          v2.4.0 Pro
        </Badge>
      </div>
    </footer>
