...
const numberFieldButtonVariants = cva(
  "nodrag relative flex shrink-0 cursor-pointer items-center justify-center transition-colors text-muted-foreground hover:text-foreground hover:bg-muted active:bg-muted/80 disabled:pointer-events-none disabled:opacity-30",
  {
    variants: {
      size: {
        sm: "w-7 h-full [&_svg]:size-3.5",
        default: "w-8 h-full [&_svg]:size-4",
        lg: "w-9 h-full [&_svg]:size-4",
      },
    },
    defaultVariants: {
      size: "default",
  ...
  return (
    <NumberFieldPrimitive.Decrement
      className={cn(
        ...
        "rounded-s-lg border-r border-border/60",
        className
      )}
...
function NumberFieldIncrement({
  ...
  return (
    <NumberFieldPrimitive.Increment
      className={cn(
        numberFieldButtonVariants({ size }),
        "rounded-e-lg border-l border-border/60",
        className
      )}
